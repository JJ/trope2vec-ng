...
\begin{document} 
 ...
 % This is what you say above - JJ	
	...
	\begin{enumerate}
        ...
        \item For the second method, we have created the corpus through the reinforcement of the relations between tropes and films as if it were a relational database. In order to compare both approaches we have selected same films for both methods.
	 \end{enumerate}
