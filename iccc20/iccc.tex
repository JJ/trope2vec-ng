...
\begin{document} 
    ...
    Word2vec has proven to be a very useful tool when obtaining a vector representation of concepts including their context. 
    
     However, in order to apply this algorithm, it is necessary to have a sufficiently large corpus. Some examples of these frequently used corpus are Wikipedia or google news dumps.
    
    	
	   % I don't know why this works starts and why. Please J, you know antecedents, please, help me to write that. 
	...
	% Second, state the need for your work, as an opposition between what the scientific community currently has and what it wants.
	   ...
	   % Same as previous point, I do not have information about the need of this work. J, please, if possible help me to write that. 
