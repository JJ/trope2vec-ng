...
my $num_args = $#ARGV + 1;
if ($num_args != 3) {
    print "Usage: checking_list_accuracy.pl <json_file> <top_100_films> <tropes_ranking_file>\n";
    exit;
}
...
my $top_100_file = $ARGV[1];
my $tropes_ranking_file = $ARGV[2];
...
open my $fh_films, ">", "tropes_accuracy_list.txt";
